...
const init = () => {
    ...
    // 创建子元素几何体
    const childCubeGeometry = new THREE.BoxGeometry(0.5, 0.5, 0.5);
    // 创建子元素材质
    const childCubeMaterial = new THREE.MeshBasicMaterial({ color: '#ff0000' });
    const childCube = new THREE.Mesh(childCubeGeometry, childCubeMaterial);
    childCube.position.set(0, 2, 0);
